...
\begin{lstlisting}[language=Gherkin, caption=Escenario: Búsqueda y reproducción de canción]
...
\begin{lstlisting}[language=Gherkin, caption=Escenario: Sesión colaborativa sincronizada]
...
\begin{lstlisting}[language=Gherkin, caption=Escenario: Edición colaborativa]
...
\begin{lstlisting}[language=Gherkin, caption=Escenario: Operación offline]
...
Scenario: Tocar canciones previamente cargadas sin conexion
  ...
  And marqué las canciones como "favoritas"
