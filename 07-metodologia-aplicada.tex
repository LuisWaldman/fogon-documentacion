...
\hline
\colorbox{gray!15}{\parbox{0.62\textwidth}{\textbf{Tareas}}} & \colorbox{gray!15}{\parbox{3.2cm}{\centering\textbf{Duración (horas)}}} \\
\hline
...
\begin{itemize}
\item El Visual Code como entorno de desarrollo integrado (IDE) principal para escribir y depurar el código.
\item Vite como herramienta de construcción y empaquetado del proyecto.
\item Git y GitHub para el control de versiones y la colaboración en el desarrollo del proyecto.
\item El modelo Claude Sonnet 4.5 para desarrollo de pruebas, de código y de vistas.
\item Jira para la gestión de proyectos y seguimiento de tareas.
\end{itemize}
