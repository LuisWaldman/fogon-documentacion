...
La clase reproductor administra la cancion y el momento actual. Implementa
el patrón Strategy para reproducir en una sesion o en modo desconectado.


\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{out/diaguml/diagrama-clase-reproductor/diagrama-clase-reproductor}
\caption{Diagrama de clases del Reproductor}
\end{figure}
