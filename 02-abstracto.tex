...
\textbf{Palabras Clave:} Música, Letras, Acordes, Partituras, Web, Sincronismo, Vue.js, WebSocket, WebRTC, Compensación de *jitter*, Diseño responsivo, Golang, NUnit, Playwright.
...
\textbf{Keywords:} Music, Lyrics, Chords, Sheet Music, Web, Synchronization, Vue.js, WebSocket, WebRTC, Jitter compensation, Responsive design, Golang, NUnit, Playwright.
